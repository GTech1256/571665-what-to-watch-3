...
const Main = ({
  ...
  const handleClickOnMainFilm = () => {
    onFilmClick(filmOnHeader);
  };
      ...
      <React.Fragment>
        ...
        <section className="movie-card">
          <div className="movie-card__bg">
            <img src="img/bg-the-grand-budapest-hotel.jpg" alt={filmOnHeader.name} />
          </div>
          ...
          <div className="movie-card__wrap">
            <div className="movie-card__info">
              <div className="movie-card__poster">
                <img src="img/the-grand-budapest-hotel-poster.jpg" alt={`${filmOnHeader.name} poster`} width="218" height="327" />
              </div>

              <div className="movie-card__desc">
                <h2
                  className="movie-card__title"
                  onClick={handleClickOnMainFilm}
                >
                  {filmOnHeader.name}
                </h2>
                <p className="movie-card__meta">
                  <span className="movie-card__genre">{filmOnHeader.genre}</span>
                  <span className="movie-card__year">{filmOnHeader.releaseDate}</span>
                </p>
